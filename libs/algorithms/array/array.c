...
unordered_array_set unordered_array_set_symmetricDifference(unordered_array_set
    ...
    unordered_array_set result = unordered_array_set_union(difference1,
                                                           difference2);
    return result;
}
...
void test_unordered_array_set_isSubset1() {
    unordered_array_set set1 = unordered_array_set_create_from_array (( int [])
                                                                              {1, 2, 3}, 3);
    unordered_array_set set2 = unordered_array_set_create_from_array((int []) {1,
                                                                               2, 3, 4}, 4);
...
void test_unordered_array_set_symmetricDifference1() {
    ...
    unordered_array_set set2 = unordered_array_set_create_from_array (( int [])
                                                                              {2 , 3} , 2) ;
    unordered_array_set resSet = unordered_array_set_symmetricDifference ( set1 ,
                                                                           set2 ) ;
    unordered_array_set expectedSet = unordered_array_set_create_from_array ((
                                                                                     int []) {1, 3} , 2) ;
    assert ( unordered_array_set_isEqual ( resSet , expectedSet ) ) ;
